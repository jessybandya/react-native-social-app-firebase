...
const Postcardowner = ({postId,ownerId,postCaption,postImage,timestamp,profileView,postId1,navigation}) => {
...
<View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
    <View>
        ...
        <Text style={styles.timestamp}>{parseTimestamp(timestamp)}</Text>
    </View>
