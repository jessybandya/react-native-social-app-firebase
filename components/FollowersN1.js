...
const FollowersN1 = ({postId,followedId,followerId,count,read,timestamp,navigation}) => {

    const [profileUserData, setProfileUserData] = useState();
    const [post, setPost] = useState();

    useEffect(() => {
        db.collection('users').doc(followerId).onSnapshot((doc) => {
...
<View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
 <View>
     ...
     <Text style={[styles.name,{color:"#DCDCDC"}]}>{profileUserData?.username} started following you</Text>
    ...
    <View style={{ flex: 1 }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
            <View>
                ...
                <Text style={styles.name}>{profileUserData?.username} started following you</Text>
