...
import { StyleSheet,View, Text,Button,Image,SafeAreaView,ScrollView,TouchableOpacity } from 'react-native'
...
const PostCard = ({postId,ownerId,postCaption,postImage,timestamp,viewPost,profileView,postId1}) => {
